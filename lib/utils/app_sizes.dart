...
/// Constant AppSizes to be used in the app (paddings, gaps, rounded corners etc.)
class AppSizes {
  const AppSizes._();
...
const gapW60 = SizedBox(width: AppSizes.p60);
...
const gapH60 = SizedBox(height: AppSizes.p60);